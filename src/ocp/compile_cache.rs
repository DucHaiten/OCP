...
use crate::ocp::hir::{build_hir_and_hash, canonical_hir_bytes, HIR_SCHEMA_VERSION};
use crate::ocp::parse::parse_program;
...
fn encode_meta(
    ...
    out.push('\n');
    out.push_str("ocp_version=");
    out.push_str(&input.ocp_version);
    out.push('\n');
