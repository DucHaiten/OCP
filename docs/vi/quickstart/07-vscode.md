...
- Nếu chưa có extension, cài VSIX `ocp-vscode-v1.0.0.vsix`.
- Mở file `.ocp` để nhận syntax highlight + snippets; trong workspace trusted, extension sẽ bật LSP/DAP từ bundled runtimes.
