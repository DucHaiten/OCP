# OCP-OCL Trademark Policy

## 1) Mục đích

File này giải thích cách tên và thương hiệu OCP-OCL được phép sử dụng trong bối cảnh public release, fork, community build, và tài liệu giới thiệu.
...
- giữ cho người dùng có thể phân biệt rõ đâu là bản OCP-OCL chính thức, đâu là bản dẫn xuất.

## 2) Phạm vi

Policy này áp dụng cho:
- tên dự án `OCP-OCL`;
- cách mô tả `Official OCL Build` hoặc các cụm gần nghĩa;
...
Việc được phép dùng mã nguồn theo license không tự động đồng nghĩa với được phép trình bày sản phẩm của bạn như một bản chính thức của OCP-OCL.

## 3) Official OCL Build là gì?

Một bản build chỉ nên được gọi là `Official OCL Build` khi đồng thời thỏa các điều kiện sau:
...
- mô tả trung thực phần nào của OCP-OCL mình đang kế thừa.

Fork hoặc community build không được:
- tự trình bày như thể đó là bản phát hành chính thức của OCP-OCL;
...
## 5) Quy tắc dùng tên “OCP-OCL”

Được phép:
- nhắc tới OCP-OCL để chỉ nguồn gốc dự án;
- mô tả tương thích hoặc nguồn gốc một cách trung thực;
- dùng câu như:
  - `This project is based on OCP-OCL`
  - `This tool is a fork of OCP-OCL`
...
- không dùng logo hoặc bộ nhận diện của OCP-OCL để làm cho fork/community build trông như official;
- không tái đóng gói lại build khác rồi trình bày bằng branding chính thức của OCP-OCL.
...
- publisher identity khớp với chuỗi phát hành chính thức của OCP-OCL.

Ở trạng thái v1.0 hiện tại, identity public-facing cần coi là official cho extension là:
- publisher: `ocp-ocl`

Điều đó có nghĩa:
- extension do publisher khác phát hành không nên được trình bày như extension OCP-OCL chính thức;
...
- cấm mọi hình thức nhắc tới tên OCP-OCL;
- thay thế cho license mã nguồn mở.

Nó chỉ đặt ra ranh giới rõ ràng giữa:
- quyền dùng source theo license;
- và quyền trình bày sản phẩm như một bản chính thức của OCP-OCL.
...
Nếu bạn thấy một build nói là “OCP-OCL” nhưng không chứng minh được điều đó bằng chuỗi phát hành chính thức, hãy coi nó là:
- fork,
- community build,
...
Trademark policy của OCP-OCL theo hướng rất đơn giản:
- fork được phép tồn tại và được phép nói rõ nguồn gốc của mình;
- nhưng không được mạo danh bản chính thức;
- chỉ build nằm trong official release + trust chain mới nên được gọi là `Official OCL Build`.
