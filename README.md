...
## What is OCP
- EN: OCP is a governed general-purpose language/runtime with deterministic `observe -> 4-kind -> commit` execution.
- VI: OCP là ngôn ngữ/runtime đa dụng có kiểm soát, khóa theo mô hình `observe -> 4-kind -> commit`.
...
## Migration
- EN: Extension migration note (`.ocp -> .ocp`): `docs/en/migration/ocp-to-ocp-phase1.md`.
- VI: Ghi chú migration đuôi file (`.ocp -> .ocp`): `docs/vi/migration/ocp-to-ocp-phase1.md`.
