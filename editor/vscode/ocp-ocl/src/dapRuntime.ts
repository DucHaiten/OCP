...
class OclDebugAdapterFactory implements vscode.DebugAdapterDescriptorFactory {
...
class OclDebugConfigurationProvider implements vscode.DebugConfigurationProvider {
