...
class OcpLspRuntime implements vscode.Disposable {
  private readonly diagnostics = vscode.languages.createDiagnosticCollection("ocp");
  ...
  private registerProviders(): void {
    ...
    if (vscode.workspace.getConfiguration("ocp").get<boolean>("enableSemanticTokens", true)) {
      this.registrations.push(
