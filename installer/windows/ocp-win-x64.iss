#define MyAppName "OCP"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "OCP"
#define MyAppExeName "ocp.exe"
#define MyLspExeName "ocp-lsp.exe"
#define MyDapExeName "ocp-dap.exe"
#define MyVsixName "ocp-vscode-v1.0.0.vsix"
#define MyVsixLogName "vscode-extension-install.log"
#define MyIconFile AddBackslash(SourcePath) + "ocp-installer.ico"
...
DefaultDirName={autopf}\OCP
DisableDirPage=no
UsePreviousAppDir=no
DefaultGroupName=OCP
DisableProgramGroupPage=yes
OutputDir={#ReleaseRoot}
OutputBaseFilename=ocp-v1.0.0-setup-win-x64
Compression=lzma
...
[Tasks]
Name: "addtopath"; Description: "Add OCP CLI to PATH (recommended)"; GroupDescription: "One-time setup options:"; Flags: unchecked
...
[Files]
Source: "{#StageRoot}\ocp.exe"; DestDir: "{app}"; DestName: "ocp.exe"; Flags: ignoreversion
Source: "{#StageRoot}\ocp-lsp.exe"; DestDir: "{app}"; DestName: "ocp-lsp.exe"; Flags: ignoreversion
Source: "{#StageRoot}\ocp-dap.exe"; DestDir: "{app}"; DestName: "ocp-dap.exe"; Flags: ignoreversion
...
[Run]
Filename: "{app}\ocp.exe"; Parameters: "--version"; Description: "Verify OCP CLI installation"; Flags: postinstall nowait skipifsilent
Filename: "{cmd}"; Parameters: "{code:GetVSCodeInstallCommand}"; Description: "Install OCP VSCode extension"; Flags: postinstall waituntilterminated runasoriginaluser; Tasks: installvscodeext; Check: HasVSCodeCli
...
begin
  ...
  DetectFile := ExpandConstant('{tmp}\ocp-vscode-cli-path.txt');
