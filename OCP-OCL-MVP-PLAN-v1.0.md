...
- Artifacts:
  - `target/ocl/w100/contracts/required_contracts_release_report.json`
  - `target/ocl/w100/contracts/sot_signature_report.json`
...
- Artifacts:
  - `target/ocl/w100/release/release_asset_matrix_report.json`
  - `target/ocl/w100/release/release_artifact_manifest.json`
  - `target/ocl/w100/release/release_artifact_manifest.sig`
  - `target/ocl/w100/release/SHA256SUMS`
  - `target/ocl/w100/release/SHA256SUMS.sig`
  - `target/ocl/w100/release/SBOM-rust.spdx.json`
  - `target/ocl/w100/release/SBOM-vscode.spdx.json`
  - `target/ocl/w100/release/SBOM-installer.spdx.json` (theo `installer_sbom.status` trong release_asset_matrix contract)
  - `target/ocl/w100/release/release_sbom_status_report.json`
  - `target/ocl/w100/release/release_publish_scope_report.json`
  - `target/ocl/w100/release/release_dependency_policy_report.json`
  - `target/ocl/w100/release/release_verification_precedence_report.json`
...
- PASS khi:
  ...
  - post-install checks (`ocl --version`, quickstart smoke) pass.
- Artifacts:
  - `target/ocl/w100/install/win_installer_smoke_report.json`
  - `target/ocl/w100/install/portable_install_report.json`
...
- Artifacts:
  - `target/ocl/w100/docs/docs_coverage_report.json`
  - `target/ocl/w100/docs/feature_matrix_sync_report.json`
  - `target/ocl/w100/docs/docs_bilingual_structure_parity_report.json`
  - `target/ocl/w100/docs/docs_bilingual_manual_review_record.json`

### KPI-5: VSCode-grade release experience
- PASS khi:
  - VSIX cài được.
  - `.ocl` recognized + highlight + diagnostics + format + navigation + code actions + debug mode đã khóa.
  - integration tests pass trên profile OS support.
- Artifacts:
  - `target/ocl/w100/editor/vsix_release_report.json`
  - `target/ocl/w100/editor/platform_matrix_aggregate_report.json`
...
- Artifacts:
  - `target/ocl/w100/legal/legal_pack_report.json`
  - `target/ocl/w100/legal/governance_pack_report.json`
...
- Artifacts:
  - `target/ocl/w100/business/licensing_model_report.json`
  - `target/ocl/w100/business/community_policy_report.json`
  - `target/ocl/w100/business/oss_license_match_report.json`
  - `target/ocl/w100/business/commercial_terms_pointer_report.json`
  - `target/ocl/w100/business/cla_policy_contract_report.json`
...
- Artifacts:
  - `target/ocl/w100/signoff/final_findings_report.json`
  - `target/ocl/w100/signoff/v1_0_release_go_no_go.json`
  - `target/ocl/w100/signoff/final_signoff_bundle.json`
  - `target/ocl/w100/signoff/go_no_go_filename_contract_report.json`
...
Artifacts:
- `target/ocl/w100/contracts/release_required_contracts_report.json`
- `target/ocl/w100/contracts/release_sot_signature_report.json`
- `target/ocl/w100/contracts/release_asset_matrix_report.json`
- `target/ocl/w100/contracts/sot_namespace_alias_report.json`
- `target/ocl/w100/contracts/signing_trust_root_report.json`
Exit criteria:
...
- `target/ocl/w100/release/SBOM-rust.spdx.json`
- `target/ocl/w100/release/SBOM-vscode.spdx.json`
- `target/ocl/w100/release/SBOM-installer.spdx.json` (theo `installer_sbom.status` contract)
- `target/ocl/w100/release/release_sbom_status_report.json`
- `target/ocl/w100/release/release_publish_scope_report.json`
- `target/ocl/w100/release/verify_download_trust_root_report.json`
- `target/ocl/w100/release/packaging_toolchain_report.json`
- `target/ocl/w100/release/release_dependency_policy_report.json`
- `target/ocl/w100/release/release_verification_precedence_report.json`
Exit criteria:
...
Artifacts:
- `target/ocl/w100/install/win_installer_smoke_report.json`
- `target/ocl/w100/install/win_uninstall_smoke_report.json`
- `target/ocl/w100/install/portable_install_report.json`
- `target/ocl/w100/install/installer_toolchain_report.json`
- `target/ocl/w100/install/installer_signing_identity_report.json`
Exit criteria:
...
- dọn bộ `OCP-OCL-MVP-PLAN-v*.md` để root chuyên nghiệp:
  - archive các bản lịch sử vào `docs/plans/history/`.
  - tạo `docs/plans/INDEX.md` làm điểm vào duy nhất.
  - root chỉ giữ plan hiện hành `OCP-OCL-MVP-PLAN-v1.0.md`.
...
- `target/ocl/w100/docs/docs_coverage_report.json`
- `target/ocl/w100/docs/feature_matrix_sync_report.json`
- `target/ocl/w100/docs/docs_quickstart_report.json`
- `target/ocl/w100/docs/docs_language_policy_report.json`
- `target/ocl/w100/docs/docs_bilingual_structure_parity_report.json`
- `target/ocl/w100/docs/docs_bilingual_manual_review_record.json`
- `target/ocl/w100/docs/docs_link_redirect_policy_report.json`
- `target/ocl/w100/docs/docs_repo_layout_report.json`
- `target/ocl/w100/docs/plan_archive_layout_report.json`
- `target/ocl/w100/docs/historical_evidence_path_migration_report.json`
Exit criteria:
...
- còn nhiều file `OCP-OCL-MVP-PLAN-v*.md` ở root ngoài plan hiện hành => FAIL
...
- đảm bảo `.ocl` UX baseline như contract editor.
Tests:
...
Artifacts:
- `target/ocl/w100/editor/vsix_release_report.json`
- `target/ocl/w100/editor/vsix_install_smoke_report.json`
- `target/ocl/w100/editor/platform_matrix_aggregate_report.json`
Exit criteria:
...
- `target/ocl/w100/legal/legal_pack_report.json`
- `target/ocl/w100/legal/governance_pack_report.json`
- `target/ocl/w100/legal/trademark_policy_report.json`
- `target/ocl/w100/legal/trademark_official_build_policy_report.json`
Exit criteria:
...
- `target/ocl/w100/business/licensing_model_report.json`
- `target/ocl/w100/business/community_policy_report.json`
- `target/ocl/w100/business/licensing_model_decision_report.json`
- `target/ocl/w100/business/oss_license_match_report.json`
- `target/ocl/w100/business/commercial_terms_pointer_report.json`
- `target/ocl/w100/business/cla_policy_contract_report.json`
Exit criteria:
...
- `target/ocl/w100/signoff/final_signoff_bundle.json`
- `target/ocl/w100/signoff/v1_0_release_go_no_go.json`
- `target/ocl/w100/release/publish_rehearsal_report.json`
- `target/ocl/w100/release/publish_signed_assets_scope_report.json`
- `target/ocl/w100/signoff/go_no_go_filename_contract_report.json`
Exit criteria:
...
- `target/ocl/w100/signoff/v1_0_release_go_no_go.json` = `GO`.
...
- Rule:
  - chỉ giữ ở root:
    - `OCP-OCL-MVP-PLAN-v1.0.md` (plan hiện hành).
  - toàn bộ bản lịch sử `OCP-OCL-MVP-PLAN-v0.*.md` phải chuyển vào:
    - `docs/plans/history/`
...
- `TRADEMARK.md` bắt buộc định nghĩa:
  - thế nào là `Official OCL Build` (phải thuộc signed-artifact trust chain theo manifest),
  - quy tắc dùng tên/logo cho fork,
  - quy tắc publisher identity cho VSCode extension official.
- Rule tối thiểu:
  - fork được phép dùng mô tả “based on OCL” nhưng không được trình bày như official build.
...
- Implemented:
  ...
  - tạo report artifacts cho gate tại `target/ocl/w100/contracts/*`.
- Files changed:
...
- Scope:
  ...
  - sinh đầy đủ artifacts bắt buộc của Gate 1.0-B dưới `target/ocl/w100/release/*`.
- Expected tests:
  - `cargo test --test v100_release_artifact_manifest`
  - `cargo test --test v100_release_artifact_signature`
  - `cargo test --test v100_release_checksums`
...
- Commands run:
  ...
  - `git status --short -- docs/vi/security/verify-download.md docs/en/security/verify-download.md target/ocl/w100/release`
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: `v100_release_artifact_manifest`
    - `PASS`: `v100_release_artifact_signature`
...
- Implemented:
  ...
  - thêm `tools/release/build_portable_archives.ps1` để build:
    - `ocl-v1.0.0-win-x64.zip` thật từ `ocl.exe`, `ocl-lsp.exe`, `ocl-dap.exe`, `INSTALL-NEXT-STEPS.txt`,
    - `ocl-v1.0.0-linux-x64.tar.gz` thật từ cross-build `x86_64-unknown-linux-musl`.
...
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: `ocl-v1.0.0-win-x64.zip` đã được thay bằng zip thật (magic `PK`).
    - `PASS`: `ocl-v1.0.0-linux-x64.tar.gz` đã được thay bằng gzip archive thật (magic `1F 8B`) sau cross-build `x86_64-unknown-linux-musl`.
    - `FAIL`: `ocl-v1.0.0-macos-arm64.tar.gz` vẫn là placeholder vì build `aarch64-apple-darwin` dừng ở linker/SDK của Apple (`xcrun --sdk macosx --show-sdk-path` không có trong môi trường Windows hiện tại, `rust-lld` không đủ để hoàn tất Mach-O link).
  - Regression tests (supporting only):
    - `không áp dụng`
- Kết luận gate:
  - `IN_PROGRESS`
...
- Implemented:
  - thêm workflow `.github/workflows/w100-release-portable-assets.yml` để build portable assets thật trên:
    - `ubuntu-latest` -> `ocl-v1.0.0-linux-x64.tar.gz`
    - `macos-14` -> `ocl-v1.0.0-macos-arm64.tar.gz`
...
- Scope:
  - Thêm Gate C common helper để dựng trạng thái cài đặt mô phỏng và xuất artifacts dưới `target/ocl/w100/install/*`.
...
- Implemented:
  ...
  - Sửa writer trong `v100_gate_c_common` để ghi artifacts đúng scope `target/ocl/w100/install/*` (không phụ thuộc prefix `release/` của Gate 1.0-B).
- Files changed:
  - `tests/v100_gate_b_common.rs`
...
- Scope:
  ...
  - Thêm PowerShell build helper để stage `ocl-cli.exe` thành `ocl.exe`, tạo `INSTALL-NEXT-STEPS.txt`, và gọi `ISCC.exe`.
...
- Gate/Step: 1.0-C (reopen)
- Implemented:
  - Thêm `installer/windows/ocl-win-x64.iss` làm installer script Inno Setup thật cho `ocl-v1.0.0-setup-win-x64.exe`.
  - Thêm `tools/release/build_win_installer.ps1` để:
    - resolve binary `ocl-cli.exe`,
    - stage thành `ocl.exe`,
...
- Gate/Step: 1.0-C
- Implemented:
  - Build thật Windows installer bằng Inno Setup trên máy host, sinh `target/ocl/w100/release/ocl-v1.0.0-setup-win-x64.exe`.
  - Cài silent installer ra `E:\OCP-OCL-InstallTest` (ngoài repo), xác nhận có `ocl.exe`, `INSTALL-NEXT-STEPS.txt`, và uninstaller.
  - Smoke CLI thật ngoài repo trên `E:\OCP-OCL-InstallSmoke\hello` với chính binary đã cài:
    - `ocl.exe --version`
    - `ocl.exe init ... --template tool-cli`
    - `ocl.exe check ...`
    - `ocl.exe lock sync/sign/verify ...`
    - `ocl.exe build --source-only --attest ...`
    - `ocl.exe verify --attest ...`
    - `ocl.exe run ...`
    - `ocl.exe replay ...`
    - `ocl.exe perm snapshot ...`
    - `ocl.exe perm diff ...`
- Files changed:
  - `none (verification-only outside workspace)`
- Commands run:
  - `cargo build -p ocl-cli --release`
  - `powershell -ExecutionPolicy Bypass -File tools/release/build_win_installer.ps1 -IsccPath 'D:\Inno Setup 6\ISCC.exe'`
  - `E:\OCP-OCL\target\ocl\w100\release\ocl-v1.0.0-setup-win-x64.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /DIR="E:\OCP-OCL-InstallTest"`
  - `E:\OCP-OCL-InstallTest\ocl.exe --version`
  - `E:\OCP-OCL-InstallTest\ocl.exe init E:\OCP-OCL-InstallSmoke\hello --template tool-cli`
  - `E:\OCP-OCL-InstallTest\ocl.exe check E:\OCP-OCL-InstallSmoke\hello`
  - `E:\OCP-OCL-InstallTest\ocl.exe lock sync E:\OCP-OCL-InstallSmoke\hello`
  - `E:\OCP-OCL-InstallTest\ocl.exe lock sign E:\OCP-OCL-InstallSmoke\hello --key ci-rc`
  - `E:\OCP-OCL-InstallTest\ocl.exe lock verify E:\OCP-OCL-InstallSmoke\hello --lock deps.lock.v3`
  - `E:\OCP-OCL-InstallTest\ocl.exe build E:\OCP-OCL-InstallSmoke\hello --source-only --attest`
  - `E:\OCP-OCL-InstallTest\ocl.exe verify --attest E:\OCP-OCL-InstallSmoke\hello\target\ocl\attestation`
  - `E:\OCP-OCL-InstallTest\ocl.exe run E:\OCP-OCL-InstallSmoke\hello`
  - `E:\OCP-OCL-InstallTest\ocl.exe replay E:\OCP-OCL-InstallSmoke\hello\.ocl_artifacts\f2ae9f1f769c1320`
  - `E:\OCP-OCL-InstallTest\ocl.exe perm snapshot E:\OCP-OCL-InstallSmoke\hello --out-dir E:\OCP-OCL-InstallSmoke\hello\perm_baseline`
  - `E:\OCP-OCL-InstallTest\ocl.exe perm diff E:\OCP-OCL-InstallSmoke\hello\perm_baseline\permissions.snapshot.json E:\OCP-OCL-InstallSmoke\hello\perm_baseline\permissions.snapshot.json --out E:\OCP-OCL-InstallSmoke\hello\permission_diff_report.json`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Implemented:
  - Nâng installer path từ CLI-only lên workstation bundle tối thiểu:
    - build VSIX thật `ocp-ocl-vscode-v1.0.0.vsix`,
    - bundle file VSIX đó vào installer,
    - cài installer silent ra `E:\OCP-OCL-InstallWorkstation4`,
    - cài VSIX từ chính thư mục cài đặt vào profile VSCode cách ly `E:\OCP-OCL-CodeExtensionsTest4` / `E:\OCP-OCL-CodeUserDataTest4`.
  - Xác nhận extension đã cài chứa bundled CLI thật tại `bin\win-x64\ocl.exe` và binary này chạy được `--version`.
  - Xác nhận bundled CLI trong extension dùng được trên workspace ngoài repo `E:\OCP-OCL-ExtensionBridgeSmoke4\hello` cho các luồng mà command bridge editor đang gọi:
    - `init`
    - `check --locked`
    - `doctor --out ...`
    - `fix --plan --out ...`
...
- Commands run:
  ...
  - `powershell -ExecutionPolicy Bypass -File tools/release/build_win_installer.ps1 -IsccPath 'D:\Inno Setup 6\ISCC.exe'`
  - `E:\OCP-OCL\target\ocl\w100\release\ocl-v1.0.0-setup-win-x64.exe /VERYSILENT /SUPPRESSMSGBOXES /DIR="E:\OCP-OCL-InstallWorkstation4" /MERGETASKS=!installvscodeext`
  - `D:\Microsoft VS Code\bin\code.cmd --extensions-dir E:\OCP-OCL-CodeExtensionsTest4 --user-data-dir E:\OCP-OCL-CodeUserDataTest4 --install-extension E:\OCP-OCL-InstallWorkstation4\ocp-ocl-vscode-v1.0.0.vsix --force`
  - `E:\OCP-OCL-CodeExtensionsTest4\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl.exe --version`
  - `E:\OCP-OCL-CodeExtensionsTest4\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl.exe init E:\OCP-OCL-ExtensionBridgeSmoke4\hello --template tool-cli`
  - `E:\OCP-OCL-CodeExtensionsTest4\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl.exe check E:\OCP-OCL-ExtensionBridgeSmoke4\hello --locked`
  - `E:\OCP-OCL-CodeExtensionsTest4\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl.exe doctor E:\OCP-OCL-ExtensionBridgeSmoke4\hello --out E:\OCP-OCL-ExtensionBridgeSmoke4\hello\target\ocl\editor\doctor_report.json`
  - `E:\OCP-OCL-CodeExtensionsTest4\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl.exe fix --plan E:\OCP-OCL-ExtensionBridgeSmoke4\hello --out E:\OCP-OCL-ExtensionBridgeSmoke4\hello\target\ocl\editor\permission_fix_plan.json`
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: `v100_editor_bridge_contract`
    - `PASS`: VSIX build thật có bundled CLI `extension/bin/win-x64/ocl.exe`
...
- Kết luận gate:
  - `IN_PROGRESS`
- Design alignment:
  - `PARTIAL (workstation bundle đã có CLI + VSIX + bundled CLI trong extension; nhưng runtime editor đầy đủ theo design 100% vẫn thiếu ocl-lsp/ocl-dap thật và chưa có uninstall smoke)`
- Notes/risks:
  - Installer/VSIX hiện không còn phân mảnh theo nghĩa CLI phải dựa `PATH`; extension tự mang `ocl.exe` và command bridge có thể gọi trực tiếp binary này.
...
- Scope:
  ...
  - Không claim hoàn thành LSP/DAP nếu repo chưa có `ocl-lsp`/`ocl-dap` runtime thật.
- Expected tests:
...
- Implemented:
  ...
  - Cập nhật `build_vsix.ps1` để bundle `ocl.exe` vào `bin\win-x64\ocl.exe`.
...
- Notes/risks:
  ...
  - Muốn đóng `DONE` phải có evidence thật cho `ocl-lsp`/`ocl-dap` hoặc phải sửa lại scope/contract release cho trung thực.

### 2026-03-07 - 1.0-C Partial Implementation Closeout (installer UX lock: icon + dir choice + PATH confirm)
- Date: 2026-03-07
- Gate/Step: 1.0-C
- Implemented:
  - Bổ sung icon installer thật `installer/windows/ocl-installer.ico` sinh từ logo OCL bằng script tái lập được `tools/release/render_installer_icon.py`.
  - Cập nhật Inno Setup script để:
    - dùng icon OCL cho installer,
    - giữ nguyên trang chọn thư mục cài đặt,
    - hiển thị lựa chọn `Add OCP-OCL CLI to PATH (recommended)` như một xác nhận rõ ràng,
...
- Notes/risks:
  ...
  - Blocker còn lại để gọi “cài xong dùng toàn bộ OCL” vẫn là thiếu runtime `ocl-lsp` / `ocl-dap` thật trong repo build hiện tại.
...
- Scope:
  ...
  - Archive toàn bộ `OCP-OCL-MVP-PLAN-v0*.md` vào `docs/plans/history/`, tạo `docs/plans/INDEX.md`, cập nhật migration path trong `contracts/history/evidence_index.v1.json` và ký lại `.sig`.
...
- Implemented:
  ...
  - Dọn plan archive layout:
    - di chuyển toàn bộ `OCP-OCL-MVP-PLAN-v0*.md` sang `docs/plans/history/`
    - di chuyển `OCP-OCL-v0.2.md` sang `docs/plans/history/`
...
- Files changed:
  ...
  - `docs/FEATURE_MATRIX.md`
  - `docs/plans/INDEX.md`
  - `docs/plans/history/*` (archive plans v0.*, plus `OCP-OCL-v0.2.md`)
...
- Commands run:
  ...
  - `cargo test --test v100_release_required_contracts`
  - `PowerShell: $env:OCL_UPDATE_V100_SOT_SIG='1'` rồi `cargo test --test v100_release_sot_signature_verify`
...
- Gate/Step: 1.0-C
- Why:
  - Sau khi đã có installer build thật và workstation bundle có VSIX, phần còn lại để được quyền gọi là “cài một lần dùng được toàn bộ OCL đã ship” là:
    - bundle đầy đủ `ocl.exe` + `ocl-lsp.exe` + `ocl-dap.exe`,
...
- Scope:
  - Đồng bộ installer/VSIX để cùng mang đủ `ocl.exe`, `ocl-lsp.exe`, `ocl-dap.exe`.
...
- Expected tests:
  ...
  - `cargo test -p ocl-lsp -p ocl-dap`
  - `powershell -ExecutionPolicy Bypass -File tools/release/build_vsix.ps1`
  - `powershell -ExecutionPolicy Bypass -File tools/release/build_win_installer.ps1 -IsccPath 'D:\Inno Setup 6\ISCC.exe'`
...
- Implemented:
  - Hoàn tất đường cài “một lần” theo scope workstation:
    - installer cài `ocl.exe`, `ocl-lsp.exe`, `ocl-dap.exe`,
    - bundle `ocp-ocl-vscode-v1.0.0.vsix`,
    - giữ icon OCL, chọn thư mục cài, opt-in PATH, auto-install extension khi phát hiện VSCode.
  - Build thật installer Windows bằng Inno Setup, cài ra `E:\OCP-OCL-FullInstall`, xác nhận payload đầy đủ.
  - Cài VSIX từ chính payload đã cài vào profile VSCode cách ly `E:\OCP-OCL-CodeExtensionsFull` / `E:\OCP-OCL-CodeUserDataFull`.
  - Chạy smoke giao thức LSP/DAP thật trên bundled binaries trong extension đã cài.
  - Chạy uninstaller thật `unins000.exe` và xác nhận thư mục `E:\OCP-OCL-FullInstall` không còn tồn tại.
...
- Commands run:
  - `cargo test --test v100_editor_bridge_contract --test v100_installer_script_contract --test v100_installer_toolchain_contract --test v100_win_installer_smoke --test v100_win_uninstall_smoke --test v100_portable_install_smoke --test v100_install_next_steps_output`
  - `cargo test -p ocl-lsp -p ocl-dap`
  - `cargo build --release -p ocl-cli -p ocl-lsp -p ocl-dap`
  - `powershell -ExecutionPolicy Bypass -File tools/release/build_vsix.ps1`
  - `powershell -ExecutionPolicy Bypass -File tools/release/build_win_installer.ps1 -IsccPath 'D:\Inno Setup 6\ISCC.exe'`
  - `E:\OCP-OCL\target\ocl\w100\release\ocl-v1.0.0-setup-win-x64.exe /VERYSILENT /SUPPRESSMSGBOXES /DIR="E:\OCP-OCL-FullInstall"`
  - `D:\Microsoft VS Code\bin\code.cmd --extensions-dir E:\OCP-OCL-CodeExtensionsFull --user-data-dir E:\OCP-OCL-CodeUserDataFull --install-extension E:\OCP-OCL-FullInstall\ocp-ocl-vscode-v1.0.0.vsix --force`
  - `powershell -ExecutionPolicy Bypass -File tools/release/smoke_editor_runtime.ps1 -LspPath E:\OCP-OCL-CodeExtensionsFull\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl-lsp.exe -DapPath E:\OCP-OCL-CodeExtensionsFull\ocp-ocl.ocp-ocl-1.0.0\bin\win-x64\ocl-dap.exe -LspFixture tests\fixtures\v19\lsp\navigation.ocl -DapFixture tests\fixtures\v19\dap\session.ocl -WorkspaceFolder E:\OCP-OCL-FullSmoke\hello`
  - `Start-Process -FilePath 'E:\OCP-OCL-FullInstall\unins000.exe' -ArgumentList '/VERYSILENT','/SUPPRESSMSGBOXES','/NORESTART' -Wait`
  - `Get-ChildItem E:\OCP-OCL-FullInstall -Force`
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: `v100_installer_script_contract`
    - `PASS`: `v100_installer_toolchain_contract`
    ...
    - `PASS`: uninstaller thật gỡ sạch thư mục `E:\OCP-OCL-FullInstall`
  - Regression tests (supporting only):
    - `PASS`: `v100_editor_bridge_contract`
    - `PASS`: `cargo test -p ocl-lsp -p ocl-dap`
...
- Gate/Step: 1.0-E
- Why:
  - Sau partial bridge closeout, blocker cuối cùng của Gate `1.0-E` là thiếu runtime editor thật (`ocl-lsp` / `ocl-dap`) và thiếu bằng chứng protocol smoke trực tiếp.
- Scope:
  - Thêm crate runtime thật cho `ocl-lsp` và `ocl-dap`.
  - Wire VSCode extension để spawn bundled `ocl-lsp.exe` / `ocl-dap.exe` trong workspace trusted.
  - Bundle ba binary `ocl.exe` / `ocl-lsp.exe` / `ocl-dap.exe` vào VSIX và installer.
...
- Expected tests:
  ...
  - `powershell -ExecutionPolicy Bypass -File tools/release/smoke_editor_runtime.ps1 ...`
- Exit criteria:
  - Repo có runtime `ocl-lsp` / `ocl-dap` thật và build được.
...
- Implemented:
  - Thêm crate runtime thật:
    ...
    - `projects/ocp-ocl/crates/ocl-dap`
  - `ocl-lsp` hỗ trợ thực thi thật các flow editor cốt lõi:
    ...
    - code actions,
    - semantic tokens.
  - `ocl-dap` hỗ trợ debug adapter replay-backed tối thiểu:
  ...
  - VSCode extension được wire lại để:
    ...
    - spawn `ocl-lsp.exe` cho LSP providers,
    - register `ocl-dap.exe` làm debug adapter factory,
    - giữ trust gating trung thực cho workspace untrusted.
  - Build pipeline VSIX/installer được mở rộng để bundle đủ `ocl.exe`, `ocl-lsp.exe`, `ocl-dap.exe`.
...
- Files changed:
  ...
  - `editor/vscode/ocp-ocl/src/runtimePaths.ts`
  - `editor/vscode/ocp-ocl/src/lspClient.ts`
  - `editor/vscode/ocp-ocl/src/dapRuntime.ts`
  - `editor/vscode/ocp-ocl/src/extension.ts`
  - `editor/vscode/ocp-ocl/src/commands.ts`
  - `editor/vscode/ocp-ocl/dist/runtimePaths.js`
  - `editor/vscode/ocp-ocl/dist/lspClient.js`
  - `editor/vscode/ocp-ocl/dist/dapRuntime.js`
...
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: `cargo test -p ocl-lsp -p ocl-dap`
    - `PASS`: `v100_editor_bridge_contract`
    - `PASS`: VSIX bundle chứa đủ `ocl.exe`, `ocl-lsp.exe`, `ocl-dap.exe`
    - `PASS`: cài VSIX thật vào profile VSCode cách ly
    - `PASS`: protocol smoke thật cho `ocl-lsp` / `ocl-dap`
  - Regression tests (supporting only):
    - `PASS`: `v100_installer_script_contract`
    - `PASS`: `v100_installer_toolchain_contract`
    - `PASS`: `v100_win_installer_smoke`
...
- Gate/Step: 1.0-C
- Implemented:
  - Phát hiện regression thực tế trên máy người dùng: dù installer hiển thị task `Install OCP-OCL VSCode extension`, profile VSCode thật vẫn không có `ocp-ocl`, nên `.ocl` vẫn hiện như text file thường.
...
- Commands run:
  ...
  - `D:\Microsoft VS Code\bin\code.cmd --uninstall-extension ocp-ocl.ocp-ocl`
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: xác nhận profile VSCode thật trước đó không có `ocp-ocl`
...
- Test results:
  - Targeted tests (must-pass for gate):
    ...
    - `PASS`: `v100_install_next_steps_output`
    - `PASS`: `v100_installer_toolchain_contract`
    - `PASS`: build lại `target/ocl/w100/release/ocl-v1.0.0-setup-win-x64.exe`
  - Regression tests (supporting only):
    - `không áp dụng`
- Kết luận gate:
  - `IN_PROGRESS`
...
- Gate/Step: 1.0-C
- Implemented:
  - Vá `[Run]` entry cài VSIX trong `installer/windows/ocl-win-x64.iss` để thêm cờ `runasoriginaluser`.
...
- Test results:
  - Targeted tests (must-pass for gate):
    - `PASS`: `v100_installer_script_contract`
    - `PASS`: `v100_installer_toolchain_contract`
    - `PASS`: build lại `E:\OCP-OCL\target\ocl\w100\release\ocl-v1.0.0-setup-win-x64.exe`
  - Regression tests (supporting only):
    - `không áp dụng`
- Kết luận gate:
  - `IN_PROGRESS`
- Design alignment:
  - `PARTIAL (đã vá đúng nhánh VSCode profile thật ở mức installer source + targeted test + artifact build; còn chờ retest cài thật trên máy người dùng để xác nhận `.ocl` được nhận tự động)`
- Notes/risks:
  - Warning `PrivilegesRequired=admin` đi cùng vùng `HKCU` vẫn còn và chưa được giải quyết ở vòng vá này.
  - Không được kết luận pass cho ca profile VSCode thật cho tới khi chính installer mới được cài lại và `.ocl` được nhận mà không cần cài tay VSIX.

### 2026-03-08 - 1.0-C Reopen Partial Implementation Closeout (resolve absolute `code.cmd` path)
- Date: 2026-03-08
- Gate/Step: 1.0-C
- Implemented:
  - Bổ sung nhánh dò tuyệt đối `code.cmd` trong `ResolveVSCodeCliPath` bằng cách gọi `where code.cmd > {tmp}\ocl-vscode-cli-path.txt`, rồi đọc dòng đầu tiên và chỉ chấp nhận khi `FileExists(...)` pass.
...
- Notes/risks:
  ...
  - Chưa được phép kết luận pass cho tới khi người dùng cài chính artifact mới và `code.cmd --list-extensions --show-versions` hiển thị `ocp-ocl.ocp-ocl`.
...
- Gate/Step: 1.0-C
- Implemented:
  - Chuyển task `Add OCP-OCL CLI to PATH` từ `HKCU\Environment` sang machine PATH ở `HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Environment`.
...
- Test results:
  - Targeted tests (must-pass for gate):
    ...
    - `PASS`: `v100_install_next_steps_output`
    - `PASS`: `v100_installer_toolchain_contract`
    - `PASS`: build lại `E:\OCP-OCL\target\ocl\w100\release\ocl-v1.0.0-setup-win-x64.exe` không còn warning `admin + HKCU`
  - Regression tests (supporting only):
    - `không áp dụng`
- Kết luận gate:
  - `IN_PROGRESS`
...
- Implemented:
  ...
  - Xác nhận lại đủ hành vi của bản cài chuẩn:
    ...
    - `.ocl` được VSCode nhận sau cài.
  - Giữ artifact phát hành cuối cho Gate `1.0-C` tại `E:\OCP-OCL\target\ocl\w100\release\ocl-v1.0.0-setup-win-x64.exe`.
- Files changed:
  - `OCP-OCL-MVP-PLAN-v1.0.md`
- Commands run:
  - `cargo test --test v100_win_installer_smoke --test v100_win_uninstall_smoke --test v100_portable_install_smoke --test v100_install_next_steps_output --test v100_installer_toolchain_contract --test v100_installer_signing_identity`
- Test results:
  - Targeted tests (must-pass for gate):
    ...
    - `PASS`: `v100_installer_toolchain_contract`
    - `PASS`: `v100_installer_signing_identity`
    - `PASS`: retest máy thật của người dùng cho custom VSCode path + auto-install extension + `.ocl` recognition
  - Regression tests (supporting only):
    - `không áp dụng`
- Kết luận gate:
  - `DONE`
...
- Scope:
  ...
  - Giải thích rõ:
    ...
    - dual-license trong OCL nghĩa là gì,
...
- Files changed:
  ...
  - `OCP-OCL-MVP-PLAN-v1.0.md`
- Commands run:
  - `rg -n "GNU AFFERO GENERAL PUBLIC LICENSE|AGPL-3.0" e:\OCP-OCL`
  - `Get-ChildItem -Path 'e:\OCP-OCL' -Filter 'LICENSE*' | Select-Object Name,Length`
  - `Get-Content -Path 'e:\OCP-OCL\LICENSE' -TotalCount 8`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Files changed:
  ...
  - `OCP-OCL-MVP-PLAN-v1.0.md`
- Commands run:
  - `Get-Content -Path 'e:\OCP-OCL\contracts\business\v1.0\licensing_model.v1.json'`
  - `Get-Content -Path 'e:\OCP-OCL\contracts\business\v1.0\community_contribution_policy.v1.json'`
  - `Select-String -Path 'e:\OCP-OCL\OCP-OCL-MVP-PLAN-v1.0.md' -Pattern 'Gate 1.0-G|commercial' -Context 0,18`
  - `Get-Content -Path 'e:\OCP-OCL\docs\vi\legal\licensing.md'`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Files changed:
  ...
  - `OCP-OCL-MVP-PLAN-v1.0.md`
- Commands run:
  - `Get-Content -Path 'e:\OCP-OCL\CONTRIBUTING.md'`
  - `Select-String -Path 'e:\OCP-OCL\OCP-OCL-MVP-PLAN-v1.0.md' -Pattern 'governance|CODEOWNERS|official build|TRADEMARK' -Context 0,16`
  - `if (Test-Path 'e:\OCP-OCL\GOVERNANCE.md') { Get-Content -Path 'e:\OCP-OCL\GOVERNANCE.md' }`
  - `if (Test-Path 'e:\OCP-OCL\CODEOWNERS') { Get-Content -Path 'e:\OCP-OCL\CODEOWNERS' }`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Files changed:
  ...
  - `OCP-OCL-MVP-PLAN-v1.0.md`
- Commands run:
  - `rg -n "DucHaiten|OCP-OCL" e:\OCP-OCL\README.md e:\OCP-OCL\docs e:\OCP-OCL\GOVERNANCE.md e:\OCP-OCL\CONTRIBUTING.md`
  - `if (Test-Path 'e:\OCP-OCL\CODEOWNERS') { Get-Content -Path 'e:\OCP-OCL\CODEOWNERS' }`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Implemented:
  ...
  - Khóa rõ các điểm public-facing bắt buộc:
    - thế nào là `Official OCL Build`,
    - fork/community build được phép nói `based on OCP-OCL` nhưng không được mạo danh official,
    - branding/logo không được dùng để gây nhầm lẫn official status,
    - publisher identity cho extension VSCode official hiện là `ocp-ocl`.
- Files changed:
  - `TRADEMARK.md`
  - `OCP-OCL-MVP-PLAN-v1.0.md`
- Commands run:
...
- Commands run:
  ...
  - `rg --line-number "1\.0-F|docs/en/legal|legal/" 'OCP-OCL-MVP-PLAN-v1.0.md'`
...
- Implemented:
  ...
  - Đóng dấu authorship/license metadata nhất quán ở repo/binary metadata:
    ...
    - thêm `author` + `license` vào `editor/vscode/ocp-ocl/package.json`.
  - Thêm đủ bộ targeted tests của Gate `1.0-F` và sinh reports dưới `target/ocl/w100/legal/`.
...
- Commands run:
  ...
  - `Get-Content -Path 'OCP-OCL-MVP-PLAN-v1.0.md' -Encoding utf8 | Select-Object -Skip 620 -First 120`
  ...
  - `Get-ChildItem -Path 'target/ocl/w100/release' -Force`
  - `Get-ChildItem -Path 'target/ocl/w100/release' -Recurse -Force | Where-Object { $_.Name -like '*manifest*' -or $_.Name -like '*.sig' }`
  - `Get-Content -Path 'contracts/legal/v1.0/trademark_policy.v1.json' -Encoding utf8`
  - `cargo test --test v100_legal_pack_presence --test v100_legal_consistency --test v100_governance_pack_presence --test v100_codeowners_policy --test v100_trademark_policy_presence --test v100_trademark_official_build_policy`
  - `$env:OCL_UPDATE_V100_REQUIRED_CONTRACTS='1'; cargo test --test v100_release_required_contracts`
  - `$env:OCL_UPDATE_V100_SOT_SIG='1'; cargo test --test v100_release_sot_signature_verify`
  - `cargo test --test v100_release_required_contracts --test v100_release_sot_signature_verify`
  - `rg --line-number "binary metadata|repo/binary metadata|copyright metadata|authorship|author metadata|publisher metadata" 'OCP-OCL-MVP-PLAN-v1.0.md'`
  ...
  - `Get-Content -Path 'projects/ocp-ocl/crates/ocl-cli/Cargo.toml' -Encoding utf8`
  - `Get-Content -Path 'projects/ocp-ocl/crates/ocl-lsp/Cargo.toml' -Encoding utf8`
  - `Get-Content -Path 'projects/ocp-ocl/crates/ocl-dap/Cargo.toml' -Encoding utf8`
  - `Get-Content -Path 'editor/vscode/ocp-ocl/package.json' -Encoding utf8`
  - `Get-Content -Path 'projects/ocp-ocl/crates/ocl-sdk/Cargo.toml' -Encoding utf8`
  - `Get-Content -Path 'projects/ocp-ocl/crates/ocl-runtime-core/Cargo.toml' -Encoding utf8`
  - `cargo test --test v100_legal_pack_presence --test v100_legal_consistency --test v100_governance_pack_presence --test v100_codeowners_policy --test v100_trademark_policy_presence --test v100_trademark_official_build_policy`
  - `Get-ChildItem -Path 'target/ocl/w100/legal' -Force`
  - `Get-Content -Path 'target/ocl/w100/legal/legal_pack_report.json' -Encoding utf8`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Implemented:
  ...
  - Sinh đầy đủ report artifacts dưới `target/ocl/w100/business/`.
- Files changed:
  - `README.md`
  - `CONTRIBUTING.md`
...
- Commands run:
  - `Get-Content -Path 'contracts/business/v1.0/licensing_model.v1.json' -Encoding utf8`
  - `Get-Content -Path 'contracts/business/v1.0/community_contribution_policy.v1.json' -Encoding utf8`
  - `Get-Content -Path 'OCP-OCL-MVP-PLAN-v1.0.md' -Encoding utf8 | Select-Object -Skip 666 -First 80`
  ...
  - `cargo test --test v100_docs_link_redirect_policy`
  - `Get-ChildItem -Path 'target/ocl/w100/business' -Force`
  - `Get-Content -Path 'target/ocl/w100/business/licensing_model_report.json' -Encoding utf8`
- Test results:
  - Targeted tests (must-pass for gate):
...
- Scope:
  - thêm helper `tests/v100_gate_h_common.rs` để:
    - đọc gate status từ `OCP-OCL-MVP-PLAN-v1.0.md`,
    - tổng hợp findings/signoff reports dưới `target/ocl/w100/signoff/*`,
    - sinh `publish_rehearsal_report.json` và `publish_signed_assets_scope_report.json` dưới `target/ocl/w100/release/*`,
...
- Commands run:
  ...
  - `Get-Content target\ocl\w100\signoff\final_signoff_bundle.json`
  - `Get-Content OCP-OCL-MVP-PLAN-v1.0.md | Select-Object -Skip 2970 -First 220`
  - `Get-Content OCP-OCL-MVP-PLAN-v1.0.md | Select-Object -First 120`
- Test results:
  - Targeted tests (must-pass for gate):
  ...
  - Regression tests (supporting only):
    ...
    - `CHƯA_PASS` - `cargo test` (đang dừng ở `v100_install_next_steps_output` vì `ocl-v1.0.0-macos-arm64.tar.gz` vẫn là placeholder, thuộc blocker Gate 1.0-B)
    - `CHƯA_PASS` - `cargo fmt -- --check` (còn formatting drift ở nhiều file baseline ngoài phạm vi signoff, gồm `ocl-lsp`, `ocl-dap`, một số test `v100_*` và `v20_*`)
- Kết luận gate:
