...
pub const W17_SIGNATURE_SCHEMA: &str = "ocl.w17.contract.sig.v1";
...
pub const W17_PACK_ABI_SCHEMA: &str = "ocl.w17.pack_abi_spec.v1";
...
pub fn build_contract_signature_sha256_v17(
    ...
    let payload = format!(
        "ocl-w17-contract-sign-v1|contract_id={}|contract_hash_sha256={}|trust_epoch={}|signer_id={}",
