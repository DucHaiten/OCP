...
use ocp_runtime_core::run_source;
use ocp_sdk::{
...
fn temp_project_dir(tag: &str) -> PathBuf {
    let stamp = SystemTime::now()
        ...
        .expect("clock drift")
        .as_millis();
    std::env::temp_dir().join(format!("ocp_v5_w5_{tag}_{stamp}"))
}
...
fn extract_render_hash(out: &ocp_runtime_core::ExecOutput) -> String {
