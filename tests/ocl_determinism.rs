...
"#;
    ...
    let out1 = execute_program(&p, ExecConfig { step_cap: 500 }).expect("exec should pass");
    let out2 = execute_program(&p, ExecConfig { step_cap: 500 }).expect("exec should pass");
...
"#;
    ...
    let out1 = execute_program(&p1, ExecConfig { step_cap: 500 }).expect("exec should pass");
    let out2 = execute_program(&p2, ExecConfig { step_cap: 500 }).expect("exec should pass");
