...
pub fn plan_file_for_version(version_id: &str) -> Option<&'static str> {
    match version_id {
        "v0.1" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.1.md"),
        "v0.2" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.2.md"),
        "v0.3" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.3.md"),
        "v0.4" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.4.md"),
        "v0.5" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.5.md"),
        "v0.6" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.6.md"),
        "v0.7.2" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.7.2.md"),
        "v0.7.3" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.7.3.md"),
        "v0.8" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.8.md"),
        "v0.9" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.9.md"),
        "v0.10" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.10.md"),
        "v0.11" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.11.md"),
        "v0.12" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.12.md"),
        "v0.13" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.13.md"),
        "v0.14" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.14.md"),
        "v0.15" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.15.md"),
        "v0.16" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.16.md"),
        "v0.17" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.17.md"),
        "v0.18" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.18.md"),
        "v0.19" => Some("docs/plans/history/OCP-OCL-MVP-PLAN-v0.19.md"),
        _ => None,
    }
}
